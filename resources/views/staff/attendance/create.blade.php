                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('staff.attendance.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('batch_id') ? ' has-error' : '' }}">
                            <label for="batch_id" class="col-md-4 control-label">Batcht</label>

                            <div class="col-md-6">
                                <select id="batch_id" class="form-control" name="batch_id" onchange="filter(this)" required>
...
$(document).ready(function() {
    ...
    var filter_data = {
        ...
        batch_id:   {{ count($Batchs) ? $Batchs[0]->id : 'null'}},
    ...
    window.filter = function filter(input) {
        ...
        if(filter_data.department_id != null && filter_data.batch_id != null) {
            load_data()
        }
    }
